...
<body style="background-color:#121212;">
    ...
    <h5 class="text-center" style="color: white; font-weight: bold; font-size:3vh; margin-top:8vh; margin-bottom: 4vh;"><u>CADASTRAR CONTA</u></h5>
    <form method="post" action="../../controller/insert_costumer_user.php" style="background-color: #141414; padding:2%; width:90%; margin-left: 5%; margin-right: 5%; border: solid 1px white; ">
        <div class="container">
            <div class="form-row" style="color: white; font-size: 2.5vh;">
                ...
                <div class="col-md-6 text-left">
                    <a href="../../page_login.php" style="text-align: center; font-weight: 600; font-size: 2.5vh; width: 50%;" class="btn btn-sm btn-success"><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M6 12.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-8a.5.5 0 0 0-.5.5v2a.5.5 0 0 1-1 0v-2A1.5 1.5 0 0 1 6.5 2h8A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 5 12.5v-2a.5.5 0 0 1 1 0v2z"/><path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/></svg></span> Voltar</a>
                    <br><br>
                </div>
                <div class="col-md-6 text-right">
                    <button class="btn btn-sm btn-primary" style="text-align: center; font-weight: 600; font-size: 2.5vh; width: 50%;">Cadastrar <span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16"><path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/></svg></span></button>
                </div> 
            </div>
        </div>
    </form>
